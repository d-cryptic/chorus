...
const buttonVariants = cva(
  ...
  { variants: {
      variant: {
        ...
        destructive:"bg-transparent text-destructive border border-border hover:bg-destructive/10",
      },
      size:{ default:"h-9 px-3 py-2", sm:"h-8 rounded-md px-2.5 text-xs", icon:"h-8 w-8" } },
