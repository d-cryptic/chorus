...
const DATA = {
  ...
  "/api/insights": { insights: [
    ...
    { kind: "best_time", scope: "user", subject_id: "self", confidence: 0,
      payload: JSON.stringify({ state: "insufficient_data", n: 9, need: 5 }), evidence: JSON.stringify([]), created_at: now },
  ], playbook: null },
