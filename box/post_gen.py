...
def build_prompt(idea, voice, examples, niche, pillars, *, shape="post"):
    ...
    return (
        ...
        "   Never reach for 'the real X is...' ('the real bottleneck/hack/flex/problem'). "
        "Measured: it showed up in 4 of 24 live drafts (17%) across four unrelated topics - "
        "a phrase that survives a change of subject is a template, not a thought. Say the "
