...
def llm_draft(c, pillar, voice, *, model, api_key, examples=(), niche="", room=(), link=""):
    ...
    prompt = (
        ...
        "   HARD LIMITS: at most ONE emoji, never STACKED (🔥🚀💯 together is hype; a single "
        "🔥 or 🚀 is this person's actual voice and appears in their best-performing post). "
        "At most ONE slang term in the whole reply. NEVER 'bro', 'lowkey', 'hell yes', "
        "'goated', 'no-brainer', 'gamechanger', 'this slaps', or stacked exclamation marks. "
        ...
        "'ngl' IS in this person's voice (it opens 3 of their 10 posted replies) - use it "
        "sparingly and never in more than one draft of a set; the bug was 4-in-5, not the "
        "word. Understatement beats hype every time: "
